        ...
        try {
            ...
            if (contentType && contentType.includes('application/json')) {
                ...
                if (data.token) {
                    ...
                    navigation.navigate('SinhalaDashbord')
                } else {
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <View className='flex-1 bg-white'>
                <View className="pt-3 pb-0">
                    <AntDesign name="left" size={24} color="#000502" onPress={()=>navigation.navigate('SigninSinhala')} />
                    <View className="items-center">
                        <Image source={sign} className="w-[240px] h-[235px] mb-2 mt-1" />
                    </View>
                </View>
                <View className='items-center'>
                    <Text className='pt-10 text-3xl font-semibold'>ආයුබෝවන්!</Text>
                    <Text className='pt-[45px] text-base'>ගිණුමට පිවිසීමට ඔබගේ දුරකතන අංකය</Text>
                    <Text className='pt--1 text-base'>ඇතුලත් කරන්න</Text>
                </View>
                ...
                <View className='flex-1 items-center pt-5 '>
                    ...
                    <TouchableOpacity 
                        ...
                        className="bg-gray-900 p-4 rounded-3xl mb-6 h-13 w-60">
                                <Text className="text-white text-xl text-center">පිවිසෙන්න</Text>
                    </TouchableOpacity>
                    </View>
                </View>
            </View>
