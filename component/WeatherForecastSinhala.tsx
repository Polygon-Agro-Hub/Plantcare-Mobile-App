...
//                 </Text>
//                 <Text className="text-base text-gray-600">සුළඟ </Text>
//               </View>
//               <View
...
//                 </Text>
//                 <Text className="text-sm text-gray-600">ආර්ද්‍රතාවය </Text>
//               </View>
//               <View
//                 className="bg-white p-4 rounded-l shadow-lg flex-1 mx-2 items-center"
//                 style={{
...
//                 />
//               ) : (
//                 <Text className="text-center text-lg text-gray-700">පුරෝකථන දත්ත නොමැත</Text>
//               )}
//             </ScrollView>
          ...
          <View className="p-1">
            {loading ? (
              ...
              <View className="items-center">
                ...
                <Text className="text-l text-gray-700 mb-1">
                  {getCurrentTimeDate()}
                </Text>
