...
const SupervisorEditScreen: React.FC<SupervisorEditScreenProps> = ({ navigation, route }) => {
  ...
  useFocusEffect(
    useCallback(() => {
      const handleBackPress = () => {
        navigation.navigate("ManageMembersSupervisor", { staffMemberId, farmId, membership, renew,farmName } );
        return true;
      };
      ...
      >
        <View className="flex-row items-center justify-between px-6 pb-2  py-3">
          <View className="flex-row items-center justify-between mb-2">
            <TouchableOpacity
              onPress={() => navigation.navigate("ManageMembersSupervisor", { staffMemberId, farmId, membership, renew ,farmName}) }
