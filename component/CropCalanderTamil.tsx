...
type CropCalanderProp = RouteProp<RootStackParamList, "CropCalanderTamil">;
...
const CropCalanderTamil: React.FC<CropCalendarProps> = ({ navigation, route }) => {
        ...
        {crops.map((crop, index) => (
          ...
          >
            <View className="flex-row">
              <View>
                <Text className="ml-6 text-xl mt-2">பணி {index + 1}</Text>
              </View>
            ...
            <Text className="mt-3 ml-6">நாள் {index + 1}</Text>
            <Text className="m-6">{crop.taskDescriptionTamil}</Text>
          </View>
        ))}
      </ScrollView>
...
export default CropCalanderTamil;
