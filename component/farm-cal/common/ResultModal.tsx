    ...
    return (
        <Modal transparent animationType="fade" visible={visible} onRequestClose={onClose}>
            <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.75)", alignItems: "center", justifyContent: "center" }}>
                <View className="bg-white w-3/4 shadow-lg overflow-hidden" style={{ borderRadius: 16 }}>
                    
                    {/* Yellow top bar */}
                    <View style={{ height: 10, backgroundColor: "#F5C518", width: "100%" }} />
                    ...
                    <View className="py-7 px-9 items-center">
                        ...
                        <View className="flex-row items-baseline mt-2">
                            ...
                            <Text className="text-xl font-semibold text-[#287097]">
                                {resultUnit}
                            </Text>
                        </View>
                    </View>
