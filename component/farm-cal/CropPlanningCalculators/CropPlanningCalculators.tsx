...
type CropPlanningNavigationProp = StackNavigationProp<RootStackParamList, "CropPlanningCalculators">;
...
const chunkArray = (arr: CalculatorItem[], size: number): CalculatorItem[][] => {
...
const CropPlanningCalculatorsScreen: React.FC<CropPlanningProps> = ({ navigation }) => {
...
export default CropPlanningCalculatorsScreen;