...
type OtpTamilNavigationProps = StackNavigationProp<
  RootStackParamList,
  "OtpTamilverification"
>;

interface NewCropProps {
  navigation: OtpTamilNavigationProps;
}
...
const OtpTamilVerification: React.FC<NewCropProps> = ({
  navigation,
  route,
}: any) => {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (statusCode === "1000") {
        ...
        navigation.navigate("TamilVerify"); // Navigate to the next screen
      ...
      <View className="flex justify-center items-center mt-16">
        ...
        <View className="mt-10">
          {/* <TouchableOpacity
                    ...
                    >
                        <Text style={{ fontSize: 20 }} className='text-white font-bold tracking-wide'>உறுதி</Text>
                    </TouchableOpacity> */}
...
export default OtpTamilVerification;
