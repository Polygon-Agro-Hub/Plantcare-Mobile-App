...
// Define the OtpTamilVerification screen component
const OtpTamilVerification: React.FC = ({ navigation, route }: any) => {
  ...
  // Function to handle input change with auto-cursor movement
          ...
          {otpCode.map((digit, index) => (
            ...
            >
              <TextInput
                ...
                onFocus={() =>
                  inputs[index].setNativeProps({ selection: { start: 0, end: 1 } })
