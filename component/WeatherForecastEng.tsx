...
//       return response.data.name; // Assuming the response has a 'name' field for the city
//     } catch (error) {
...
//       // If city name is retrieved, set it as the last searched city
//       if (cityName) {
//         setSearchQuery(cityName); // Set the city name in search query
//         fetchWeather(location.coords.latitude, location.coords.longitude); // Fetch weather using coordinates
  
//         try {
//           await AsyncStorage.setItem('lastSearchedCity', cityName); // Store in AsyncStorage
...
//   // Your existing code for fetching suggestions
...
//   // Your existing handle suggestion press method
...
//     onPress={() => {
//       if (weatherData) {
//         const { searchQuery } = weatherData; // Adjust this based on how your weatherData is structured
...
/>
            ...
            <TouchableOpacity className="p-2 bg-transparent ml-2s" onPress={handleLocationIconPress}>
              <Image
