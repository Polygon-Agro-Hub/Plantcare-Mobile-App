...
type MyCropNavigationProp = StackNavigationProp<RootStackParamList, "TamilMyCrop">;

interface MyCropProps {
    navigation: MyCropNavigationProp;
}

const TamilMyCrop: React.FC<MyCropProps> = ({ navigation }) => {
            ...
            <ScrollView contentContainerStyle={{ padding: 16 }}>
                {crops.map((crop) => (
                    <CropCard
                        ...
                        onPress={() =>
                            navigation.navigate("CropCalanderTamil", {
                                cropId: crop.id,
                                cropName: crop.cropName,
                            } as any)
