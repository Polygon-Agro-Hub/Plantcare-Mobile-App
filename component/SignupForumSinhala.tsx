...
type SignupForumSinhalaNavigationProp = StackNavigationProp<
  RootStackParamList,
  "SignumpFS"
>;

interface SignupForumProps {
  navigation: SignupForumSinhalaNavigationProp;
}
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex-1">
          <View className="bg-custom-green pt-0">
            <View className="pt-3 pb-0">
              <AntDesign
                ...
                size={24}
                color="#000502"
                onPress={() => navigation.navigate("SigninSinhala")}
              />
          ...
          <View className="flex-1 items-center pt-5 bg-white">
            <Text className="text-xl font-bold">ගිණුම් විස්තර පුරවන්න</Text>
            ...
            <View className="flex-1 justify-center w-64 px-4 mt-0 pb-8 pt-0">
              ...
              <View className="flex-1 items-center flex-row pt-0 pb-4">
                <Text>දැනටමත් ගිණුමක් තිබේ ද? </Text>
                <TouchableOpacity>
                  <Text
