...
const ManageMembersSupervisor = () => {
  const navigation = useNavigation<ManageMembersSupervisorNavigationProp>();
  ...
  const calculateStats = (
    ...
    setStats({
      ...
      otherStaffCount: Math.max(0, otherStaffCount),
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
        onPress={() =>
          navigation.navigate("SupervisorAddStaff", {
            farmId: farmId,
          })
        }
      >
...
export default ManageMembersSupervisor;
