...
import { View, Text, Image, ScrollView, Alert, TouchableOpacity, SafeAreaView } from 'react-native';
...
type FiveDayForecastEngNavigationProp = StackNavigationProp<RootStackParamList, 'FiveDayForecastEng'>;
...
const FiveDayForecastEng: React.FC<FiveDayForecastEngProps> = ({ navigation }) => {
    ...
    //             getLocation();
    //         } else {
    //             Alert.alert('Location Permission Required', 'Please enable location services to fetch weather data.');
    //         }
    //     };
