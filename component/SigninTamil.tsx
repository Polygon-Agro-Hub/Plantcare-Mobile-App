...
type SigninNavigationProp = StackNavigationProp<RootStackParamList, 'SigninTamil'>;
        ...
        try {
            ...
            if (contentType && contentType.includes('application/json')) {
                ...
                if (data.token) {
                    ...
                    navigation.navigate('TamilDashbord')
                } else {
    ...
    return (
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <View className='flex-1 bg-white'>
                ...
                <View className='items-center'>
                    <Text className='pt-10 text-3xl font-semibold'>வணக்கம்!</Text>
                    <Text className='pt-[45px] text-base'>கணக்கை அணுக உங்கள் தொலைபேசி எண்</Text>
                    <Text className='pt--1 text-base'>நுழைய</Text>
                </View>
                ...
                <View className='flex-1 items-center pt-5 '>
                    ...
                    <TouchableOpacity 
                        ...
                        onPress={handleLogin}
                    >
                                <Text className="text-white text-xl text-center">உள்நுழைக</Text>
                    </TouchableOpacity>
                    </View>
                </View>
            </View>
