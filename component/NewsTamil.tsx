...
type NewsNavigationProp = RouteProp<RootStackParamList, 'NewsTamil'>;
type SelectCropNavigationCrop = StackNavigationProp<RootStackParamList, 'NewsTamil'>;
...
const NewsTamil: React.FC<NewsProps> = ({ navigation, route }) => {
