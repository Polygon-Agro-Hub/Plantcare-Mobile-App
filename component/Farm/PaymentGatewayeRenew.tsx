...
type PaymentGatewayeRenewNavigationProp = StackNavigationProp<
  RootStackParamList,
  "FirstTimePackagePlan"
>;

type PaymentGatewayeRenewProps = {
  navigation: PaymentGatewayeRenewNavigationProp;
  route: RouteProp<RootStackParamList, "FirstTimePackagePlan">;
};

const PaymentGatewayeRenew: React.FC<PaymentGatewayeRenewProps> = ({
  navigation,
}) => {
...
export default PaymentGatewayeRenew;