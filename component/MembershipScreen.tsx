...
//         {/* Terms Section */}
//         <Text className="text-gray-600 text-center text-sm mb-6 p-2 ">
...
//                   {" "}
//                   <Text className="text-black">View </Text>Terms & Conditions{" "}
//                 </Text>
//               </TouchableOpacity>
//               <TouchableOpacity
...
//               >
//                 <Text className="text-blue-500">
//                   <Text className="text-black"> and </Text> Privacy Policy
//                 </Text>
//               </TouchableOpacity>
//             </Text>
//           ) : (
...
//               >
//                 <Text className="text-blue-500">
//                   නියමයන් සහ කොන්දේසි <Text className="text-black"> සහ </Text>
//                 </Text>
//               </TouchableOpacity>{" "}
//               <TouchableOpacity
//                 onPress={() => navigation.navigate("PrivacyPolicy")}
...
//                   <Text className="text-black">බලන්න</Text>
//                 </Text>
//               </TouchableOpacity>
//             </Text>
//           )}
