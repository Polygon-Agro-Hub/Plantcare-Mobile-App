...
type CropEarnCertificateRouteProp = RouteProp<RootStackParamList, "CropEarnCertificate">;
...
const CropEarnCertificate: React.FC = () => {
  const navigation = useNavigation<CropEarnCertificateNavigationProp>();
  ...
  //  console.log("Farm ID for certificate application:", farmId);
    ...
    navigation.navigate("CropPaymentScreen", {
...
export default CropEarnCertificate;