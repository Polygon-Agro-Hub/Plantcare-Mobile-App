...
type NewsNavigationProp = RouteProp<RootStackParamList, 'NewsSinhala'>;
type SelectCropNavigationCrop = StackNavigationProp<RootStackParamList, 'NewsSinhala'>;
...
const NewsSinhala: React.FC<NewsProps> = ({ navigation, route }) => {
    ...
    <View className='flex-1'>
      ...
      <View className='absolute top-0 left-0 right-0'>
        <View className='flex-row pt-5'>
          ...
          />
          <Text className='font-bold text-xl pt-4 pb-5 ml-[35%] mr-3'>පුවත්</Text>
        </View>
      </View>
