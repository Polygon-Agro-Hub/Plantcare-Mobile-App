...
const SinProfile: React.FC<SinProfileProps> = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        const handleBackPress = () => {
            navigation.navigate('SinhalaDashbord'); // Navigate to your dashboard
    ...
    const handleLogout = async () => {
        try {
            ...
            navigation.navigate('SigninSinhalasc');
        } catch (error) {
      ...
      <AntDesign
        ...
        />
            ...
            <View className="flex-row items-center mb-4">
                ...
                <TouchableOpacity
                    onPress={() => navigation.navigate('SinEditProfile')}
                >
            ...
            >
                ...
                <Text className="flex-1 text-lg ml-2">භාෂා සැකසුම්</Text>
            ...
            <TouchableOpacity className="flex-row items-center py-3"
                onPress={() => navigation.navigate('SinQRcode')}
            >
            ...
            <TouchableOpacity className="flex-row items-center py-3" onPress={() => setModalVisible(true)}>
                ...
                <Text className="flex-1 text-lg ml-2">Plant Care උපකාර සේවාව</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity className="flex-row items-center py-3" onPress={handleLogout}>
                ...
                <Text className="flex-1 text-lg ml-2 text-red-600">ඉවත් වන්න</Text>
            </TouchableOpacity>
            ...
            >
                <View className="flex-1 justify-center items-center bg-black bg-opacity-50">
                    <View className="bg-white p-6 rounded-lg shadow-lg w-80">
                        ...
                        <Text className="text-xl font-bold text-center mb-2">උපකාර අවශ්‍යද?</Text>
                        <Text className="text-base text-center mb-4">
                            PlantCare උපකාර සේවාව අවශ්‍යද? විශේෂාංග සහාය සඳහා අපගේ උපකාර මධ්‍යස්ථානය වෙත ඇමතුමක් කිරීමට සවිස්තරව සම්බන්ධ වන්න.
                        </Text>
                        <View className="flex-row justify-around">
                            ...
                            >
                                <Text className="text-center text-white">ඇමතුම</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
