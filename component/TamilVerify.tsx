...
const TamilVerify:React.FC<SinhalaVerifyProps> = ({navigation}) => {
  return (
    <SafeAreaView className='flex-1 bg-white'>
     ...
     <View className="flex justify-center items-center mt-36">
      ...
      <View className='flex justify-center items-center mt-8'>
        <Text style={{fontSize:(20)}} className='font-bold'>சரிபார்க்கப்பட்டது!</Text>
        <Text className='text-gray-300 mt-5' style={{fontSize:(16)}}>உங்கள் அடையாளம்  </Text>
        <Text className='text-gray-300' style={{fontSize:(16)}}>வெற்றிகரமாக</Text>
        <Text className='text-gray-300' style={{fontSize:(16)}}>சரிபார்க்கப்பட்டது</Text>
      </View>

      <View className='mt-20'>
        <TouchableOpacity
            onPress={()=>navigation.navigate('SigninTamil')}
            style={{height:hp(7),width:wp(80)}}
            className='bg-gray-900 flex items-center justify-center mx-auto rounded-full'    
        >
            <Text style={{fontSize:20}}className='text-white font-bold tracking-wide'>தொடர்க</Text>
        </TouchableOpacity>
      </View>
