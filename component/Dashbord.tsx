...
// import NetInfo from "@react-native-community/netinfo"; // <-- Import NetInfo for connectivity tracking
...
//     buttonWidth: screenWidth < 400 ? wp(28) : wp(35), // Adjust button width
//     buttonHeight: screenWidth < 400 ? wp(22) : wp(28), // Adjust button height
//     iconSize: screenWidth < 400 ? 40 : 50, // Adjust icon size
//     textSize: screenWidth < 400 ? 8 : 12, // Adjust text size
//     paddingTopSlideshow: screenWidth < 400 ? 30 : 20,
//     slideShowTitleSize: screenWidth < 400 ? 15 : 20,
//     paddingFromProfileImage: screenWidth < 400 ? 10 : 20,
//     paddingTopForCards: screenWidth < 400 ? 35 : 20,
//   };
...
//           >
//             <MaterialCommunityIcons name="message-processing" size={34} color="black" />
//           </TouchableOpacity>
//         </View>

//         <View
//           style={{
//             marginTop: dynamicStyles.paddingFromProfileImage,
//             marginLeft: 20,
//           }}
//         >
//           <Text
