...
type RootStackParamList = {
  OtpSinhalaVerification: undefined;
...
const OtpSinhalaVerification: React.FC = ({ navigation, route }: any) => {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (statusCode === "1000") {
        ...
        navigation.navigate("SinhalaVerify"); // Navigate to the next screen
    ...
    <SafeAreaView className="flex-1">
      ...
      <View className="flex justify-center items-center mt-16">
        ...
        <View className="mt-10">
          <Text className="text-md text-gray-400">OTP කේතය යවන ලදී</Text>
...
export default OtpSinhalaVerification;
